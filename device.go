	...
	for {
		...
		case msg := <-output:
			...
			if last != out {
				...
				ctx.DrawStringAnchored(out, 64, 32, 0.5, 0.5)
...
// fakeDeviceLoop is a test func for running this on my machine without
